...
The Lens positioning: "Your AI marketing team", 47 playbooks
plus 28 installable Claude Code skills, free to read, free to
...
- No staccato all-short-sentence rhythm. If three sentences in
  ...
  pair.
- No sentences that open with a bare number ("Forty-seven
  playbooks across..."). That is reportage cadence and reads
  like a press release. A real speaker introduces a count with
  a verb or determiner ("We've built forty-seven...", "Right now
  that's forty-seven...", "Inside, there's forty-seven...",
  "Currently forty-seven..."). Only allow a bare-number opening
...
If the user asks to batch-produce 47 playbook videos in one go, do the maths first. Multiply the expected runtime of each video by the current per-minute rate for their avatar engine from the pricing page, show the total in US dollars, and confirm before rendering. Suggest spreading the batch over weeks if the total is more than they expected.
