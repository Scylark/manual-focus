...
Twenty-eight skills total. One welcome skill, twenty-six workflow skills, and one production utility.

- **1 onboarding skill**, `setup-the-lens`, the welcome and starter-playbook recommendation.
- **26 workflow skills**, across the five stacks (brand, demand, content, ops, productivity), mapping one-to-one with a subset of the forty-seven Lens playbooks.
...
One install command brings in all 28 skills at once. After install, ask Claude to "set up The Lens" and the welcome skill takes over.
