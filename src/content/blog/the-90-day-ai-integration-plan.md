...
Here's a 90-day plan that closes that gap. Concrete, sequential, achievable without hiring or restructuring. The shape works in agencies, in in-house teams, in lean B2B functions, in commerce teams.
...
What's the brand voice doc, and is it operational? Pull it up. If it's a Notion page describing tone with adjectives, it's not operational. The voice doc has to be specific enough to be prompted from, with examples, bans and patterns. If it's not, that's your first fix.
...
The single highest-leverage thing you can do in the first month is get the brand voice prompt right. It propagates through every other workflow you'll set up later.
...
The goal at end of month one: every team member has access to the same tools, the same voice prompt, and the same baseline expectation of what AI is for.
...
Document it. Run it on three real pieces. Measure the time and quality vs the old workflow.
...
Don't try to do all of them. Two well-running rebuilt workflows beats five half-built ones. The point of this stage is to prove the pattern travels, not to maximise coverage.
...
Most AI rollouts fail here. The team produces more, but nobody tracks whether the extra output is actually working. Six months in there's no honest answer to "is this paying off".

Set up the loop:

- One dashboard, one source of truth, weekly cadence.
- Each piece of work tagged by workflow (which AI process produced it), by topic, by format.
- The model summarises what's working weekly. The senior person reads it and makes the call on what to adjust.
...
By month three the rollout has produced real changes. The team has shifted what they do day-to-day. Some people will have leaned in. Some will have resisted. A few might be checked out because they think their job is about to disappear.

This is when the leadership work matters most.

Run a one-hour session with the team. Not a strategy presentation — a conversation. What's working, what's not, where they're nervous, what they want more of. Be specific that AI doesn't reduce the senior marketing problem, it magnifies it; the people who learn to operate the workflow well end up doing more of the strategic work, not less.
...
The teams that don't do this work will spend the next year being out-shipped by teams that did. AI is not the differentiator — the disciplined integration is. And that's a leadership job, not a tools job.
